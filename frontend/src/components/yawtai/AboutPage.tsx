...
const milestones = [
  { year: '2022', title: 'Yawt Technologies Founded', desc: 'Established on October 18, 2022 with a vision to democratize AI-powered development tools.' },
  { year: '2023', title: 'Research & Development', desc: 'Built the core AI engine and developed our proprietary RAG architecture.' },
  { year: '2024', title: 'YawtAI Alpha Release', desc: 'Launched the first version of our AI coding assistant to early adopters.' },
